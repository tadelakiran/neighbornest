...
/**
 * OpenAPI 3.0 configuration for the User Service.
 *
...
@OpenAPIDefinition(
        info = @Info(
                title = "NeighborNest User Service API",
                version = "1.0.0",
                description = "User profiles, onboarding and anchor application APIs for the NeighborNest platform.",
                contact = @Contact(
