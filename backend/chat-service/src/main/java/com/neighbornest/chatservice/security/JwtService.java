 ...
 * verified here (both for REST filters and for the WebSocket STOMP
 * interceptor). Reuses the auth-service's claim layout: {@code userId},
 * {@code email}, {@code role}, {@code isOnboarded}.
 * </p>
 *
...
public class JwtService {
     ...
     * @return the auth-service user id contained in the token
     */
    ...
    /**
     * Extracts the email subject from the given JWT.
     *
     * @param token the JWT token
