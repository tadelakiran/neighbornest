...
import com.neighbornest.chatservice.dto.response.ApiResponse;
 ...
 * <p>
 * No other service calls the chat-service over Feign, so every REST endpoint
 * is frontend-facing and gets wrapped (WebSocket frames are unaffected).
 * Error bodies produced by the
 * {@link com.neighbornest.chatservice.exception.GlobalExceptionHandler} already
