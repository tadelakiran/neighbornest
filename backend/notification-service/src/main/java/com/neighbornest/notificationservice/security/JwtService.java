 ...
 * verified here. Extracts the {@code userId} and {@code role} claims used to
 * identify the caller and authorize admin endpoints.
 * </p>
 *
...
public class JwtService {
     ...
     *
     * @param token the JWT token
     * @return the role contained in the token, or {@code null}
     */
