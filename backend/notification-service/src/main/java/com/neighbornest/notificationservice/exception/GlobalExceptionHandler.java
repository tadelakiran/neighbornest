...
import com.neighbornest.notificationservice.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler {
     ...
     * <p>
     * Two concurrent first-time preference updates (or a duplicate template
     * key racing {@code existsByTemplateKey}) can collide on a unique
     * constraint; the DB constraint is the final arbiter and must surface as a
     * 409 the client can act on rather than a raw 500.
     * </p>
     */
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrityViolation(
        ...
        return buildErrorResponse(HttpStatus.CONFLICT,
                "This resource already exists or violates a uniqueness constraint.", request);
    }
