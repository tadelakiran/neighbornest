...
/**
 * Response returned after a code is successfully emailed.
 * <p>
 * Deliberately never includes the code itself — the client only learns how
 * long the code stays valid and when a resend is allowed.
 * </p>
 *
