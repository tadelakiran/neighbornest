...
public class ErrorResponse {
    ...
    @Schema(description = "Human-readable error message", example = "Template key already exists")
    private String message;

    @Schema(description = "Request path that caused the error", example = "/api/notifications/templates")
    private String path;
