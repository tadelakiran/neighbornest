...
public class ErrorResponse {
    ...
    @Schema(description = "Human-readable error message", example = "Nest not found")
    private String message;

    @Schema(description = "Request path that caused the error", example = "/api/nests/3")
    private String path;

    @Schema(description = "Field-level validation errors (if applicable)", example = "{\"name\": \"Nest name is required\"}")
